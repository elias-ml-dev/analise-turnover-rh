...
## 📋 Sobre os Dados
A base de dados utilizada neste estudo é **fictícia**, proveniente do curso *Gerando Valor com Dados* da **[Preditiva.ai](https://preditiva.ai/)**. O dataset contém registos de 1.470 funcionários com 19 variáveis, incluindo salários, horas extras e níveis de satisfação.
...
- **`/analises`**: Ficheiros consolidados com o desenvolvimento técnico:
    ...
    - **Análise 3**: **Análise de IV (Information Value)** e Odds Ratio, focada no poder preditivo de cada fator.
